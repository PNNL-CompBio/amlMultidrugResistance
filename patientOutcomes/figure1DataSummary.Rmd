...
ba_pats <- readxl::read_xlsx(synapser::synGet('syn68710501')$path) |>
  ...
  dplyr::select(patientId,labId,consensus_sex,inferred_sex,reportedRace,reportedEthnicity,inferred_ethnicity,RNASeq, Mutation) |>
  distinct()
...
ba_meta <- ba_meta |>
  ...
  mutate(Metabolomics = Accession%in%ba_met$Accession, Lipidomics = Accession%in%ba_lipids$Accession) |>
