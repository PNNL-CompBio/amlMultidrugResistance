---
title: "Ex 21 Phospho proteomics"
...
global_crosstab <- read.table(synapser::synGet('syn52751332')$path)
  #"../proteomics/data/global_data/ptrc_ex21_crosstab_global_gene_original.txt")
phospho_crosstab <- read.table(synapser::synGet('syn52751608')$path)
  #"../proteomics/data/phospho_data/ptrc_ex21_crosstab_phospho_siteID_original.txt")
...
# plot PCA #this code was deleted
...
saveRDS(m_global_corrected,file='exp_21_global.rds')
saveRDS(m_phospho_corrected,file='exp_21_phospho.rds')
