...
library(synapser)
synLogin()
global_crosstab <- read.table(synapser::synGet('syn53212317')$path)#"../proteomics/data/global_data/ptrc_ex22_crosstab_global_gene_original.txt")
phospho_crosstab <- read.table(synapser::synGet('syn53212324')$path)#"../proteomics/data/phospho_data/ptrc_ex22_crosstab_phospho_siteID_original.txt")
phospho_crosstab_prot <- read.table(synapser::synGet('syn53212327')$path)#read.table("../proteomics/data/phospho_data/ptrc_ex22_crosstab_phospho_siteID_prot_original.txt", sep = "\t")

meta <- readxl::read_xlsx(synapser::synGet('syn64731726')$path,sheet=2) |> #"../proteomics/data/Expt 22 Design.xlsx", sheet = 2) %>%
  filter(!is.na(`Tube`)) %>%
...
saveRDS(m_global_corrected,file='exp_22_global.rds')
saveRDS(m_phospho_corrected,file='exp_22_phospho.rds')
