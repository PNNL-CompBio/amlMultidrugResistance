...
synStore(File('enrichedKEGG_fdr05.pdf',parentId='syn66504213'))
fig
...
synStore(File('enrichedKEGG_ORA_fdr1.pdf',parentId='syn66504213'))
fig
...
#  mutate(description=factor(description,levels=description))|>
  ...
  geom_point()+coord_flip()+scale_color_gradient2(low='darkblue',mid='grey',high='firebrick4')+ theme(axis.text.x=element_text(angle=90, hjust=1))
#(stat='identity',position='dodge')

readr::write_csv(all_global_enrich,'go_gsea.csv')
synStore(File('go_gsea.csv',parentId='syn66504213'))
ggsave('gvGoTerms_05.pdf',width=11,height=10)
synStore(File('gvGoTerms_05.pdf',parentId='syn66504213'))
```
...
ggsave('gvKeggPaths_FDR05.pdf',width=6)
