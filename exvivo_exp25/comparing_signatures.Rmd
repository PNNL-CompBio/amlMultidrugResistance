...
padding_df <- data.frame(contrast = rep(treatment_contrasts, 2), positive = c(rep(TRUE, length(treatment_contrasts)),
                                                                              rep(FALSE, length(treatment_contrasts))),
                         total = rep(0, 2*length(treatment_contrasts)))
rownames(padding_df) <- paste(padding_df$contrast, padding_df$positive)
