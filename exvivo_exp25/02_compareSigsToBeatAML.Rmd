...
drug_treatments<-c('Venetoclax','Dasatinib','Panobinostat','Quizartinib - Venetoclax','Ruxolitinib - Venetoclax', 'Gilteritinib','Azacytidine - Venetoclax','Azacytidine','Azacytidine - Quizartinib')
...
```{r single drug,error=FALSE,warning=FALSE}
...
##let's collect the stats in a table                
res2<-do.call(rbind,lapply(singles,function(sn){
...
##let's collect the stats in a table                
res3<-do.call(rbind,lapply(singles,function(sn){
