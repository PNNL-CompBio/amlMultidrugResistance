"""Plots figure 7b: NDUFB6 and Race/NPM1."""
...
def make_figure():
    ...
    acetyl = acetyl.loc[
        :,
        acetyl.columns.str.startswith("NDUFB6")
    ].mean(axis=1)
    ...
    acetyl = acetyl.loc[meta.index.intersection(acetyl.index)].dropna()
