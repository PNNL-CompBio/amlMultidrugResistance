...
# ba_mutation <- dplyr::select(ba_meta,c(labId='Accession',Sex,Race, source, study # Note (8/6/2025): source and study columns did not originally exist, but their defs were added above
                                        ))|>left_join(muts)
...
<<<<<<< HEAD:patientOutcomes/figure1DataSummary.Rmd
  mutate(Metabolomics = Accession%in%ba_meta$Accession, Lipidomics = Accession%in%ba_lipids$Accession,Acetylomics = Accession%in%acetyl_long$Accession) |>
=======
...
>>>>>>> master:aml_outcome_disparities/fig1Summary/figure1DataSummary.Rmd
...
Can we try to plot all patients in a matrix
